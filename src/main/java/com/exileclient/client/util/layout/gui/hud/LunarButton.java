...
public class LunarButton extends Gui {
    ...
    public LunarButton(int buttonId, int x, int y, String buttonText)
    {
        this();
    }
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            RoundedUtils.drawRoundedRect(hW - 50, hH - 25, hW + 50, hH + 25, 10, 0x90000000);
